          ...
          <Container>
            ...
            <Row className="align-items-center pt-4">
              ...
              <Col md="5" className="ml-auto">
                {/* featurebox */}
                <FeatureBox num="01" title="Kanban Boards" features={this.state.features1} desc="If several languages coalesce, the grammar of the resulting language is more simple and regular than of the individual will be more simple and regular than the existing." />
              </Col>
            </Row>
            ...
            <Row className="align-items-center mt-5 pt-md-5">
              <Col md="5">
                {/* featurebox */}
                <FeatureBox num="02" title="Tasks" features={this.state.features2} desc="It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend." />
              </Col>
